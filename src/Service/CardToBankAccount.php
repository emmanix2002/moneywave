 ...
 * @property string $card_id            (optional) card ID, required in "charging with" ChargeMethod::TOKEN
 * @property string $cycle              (optional) scheduled / recurring transfer cycle
 * @property string $startDate          (optional) scheduled / recurring start date
 * @property string $endDate            (optional) scheduled / recurring end date
 *
